  ...
  return (
    <div className="animate-reveal bg-[#FCF9F5] pb-40">
      ...
      <div className="layout-container space-y-24">
         ...
         {/* SECTION 3: PROCESS */}
         <section className="py-20 px-6 bg-white rounded-[48px] border border-gray-100 text-center space-y-10 shadow-sm max-w-4xl mx-auto">
            <h2 className="heading-section">함께하는 과정</h2>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <ProcessStep num="01" title="이야기의 시작" />
              <ProcessStep num="02" title="생각 나누기" />
              <ProcessStep num="03" title="샘플 기획" />
              <ProcessStep num="04" title="함께하기" />
            </div>
...
function ProcessStep({ num, title }: { num: string; title: string }) {
  return (
    <div className="p-6 bg-[#F8F9FA] rounded-3xl border border-gray-50 flex flex-col items-center gap-3 group hover:bg-burgundy-100 transition-colors">
