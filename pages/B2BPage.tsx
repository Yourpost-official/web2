  ...
  return (
    <div className="animate-reveal bg-[#F8F9FA] pb-40">
      <section className="pt-32 pb-24 px-6 text-center max-w-screen-lg mx-auto space-y-8">
        <span className="text-burgundy-500 font-black text-[10px] tracking-[0.3em] uppercase">Enterprise Emotional Solution</span>
        ...
        <div className="pt-4 flex justify-center gap-4">
           <a href={`mailto:${b2b.email}`} className="bg-burgundy-500 text-white px-12 py-6 rounded-[40px] font-black text-xl hover:bg-burgundy-600 transition-all shadow-xl active:scale-95">
             비즈니스 도입 문의하기
           </a>
        </div>
      </section>

      <div className="max-w-screen-xl mx-auto px-6 space-y-40">
...
function B2BCard({ icon, title, desc }: any) {
  return (
    <div className="p-10 bg-white border border-gray-100 rounded-[48px] shadow-sm hover:shadow-2xl transition-all space-y-6 group">
       <div className="w-14 h-14 bg-[#F8F9FA] text-burgundy-500 rounded-2xl flex items-center justify-center group-hover:bg-burgundy-500 group-hover:text-white transition-all duration-500">
          {icon}
       </div>
