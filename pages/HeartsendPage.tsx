...
function PremiumCard({ icon, title, desc }: any) {
  return (
    <div className="card-emotional space-y-8 hover:shadow-2xl group">
...
function ScenarioBox({ title, desc, icon }: any) {
   return (
      <div className="flex items-center gap-8 p-8 md:p-10 bg-[#F8F9FA] rounded-[40px] border border-gray-100 hover:border-burgundy-200 transition-colors group">
